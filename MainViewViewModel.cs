...
using RevitAPIApplicationFiltersSpecificationLibrary;
using RevitAPIApplicationInterfaceAddingFiltersSpecification.Wrappers;
using System;
...
namespace RevitAPIApplicationInterfaceAddingFiltersSpecification
{
    public class MainViewViewModel
    {
        ...
        {
            var schedulableFied = viewSchedule.Definition.GetSchedulableFields()
                                    .FirstOrDefault(p => p.GetName(viewSchedule.Document) == parameterName);
            return schedulableFied;
        }
